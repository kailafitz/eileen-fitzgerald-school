...
const LinkAnimation = (props: Props) => {
  return (
    <span
      className={`${
        props.underline
          ? "before:w-full before:h-0.5 before:absolute before:block before:-bottom-1 before:left-0 before:bg-gray-200 before:scale-x-100"
          : ""
      } after:w-full after:h-0.5 after:absolute after:block after:${
        props.mb ? "-bottom-2" : "-bottom-0.5"
