        ...
        <div className="flex flex-col md:flex-row space-y-5 md:space-y-0 md:space-x-20 md:justify-between">
          <div className="flex flex-col justify-center w-full md:w-2/3">
            ...
            <p className="mb-10 hide-down transition-delay-1">
              ...
              your confidence and communication skills for an important
              presentation at work, speech and drama is an empowering
              discipline.
            </p>
            <Link
              href={`/classes`}
        ...
        <div className="flex flex-col md:flex-row space-y-5 md:space-y-0 md:space-x-20 md:justify-between">
          <div className="flex flex-col justify-center w-full md:w-2/3">
            ...
            <p className="mb-10 hide-down transition-delay-1">
              ...
              <br />
              <br />
              If you'd like to keep up to date with all our latest news and
